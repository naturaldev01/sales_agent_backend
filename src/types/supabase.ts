  ...
  public: {
    Tables: {
      ...
      doctor_notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "doctor_notifications_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "leads"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "doctor_notifications_read_by_fkey"
            columns: ["read_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      followup_decisions: {
        Row: {
          ...
          tokens_used: number | null
          unanswered_followup_count: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "followup_decisions_conversation_id_fkey"
          ...
          {
            foreignKeyName: "followup_decisions_followup_id_fkey"
            columns: ["followup_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "followup_decisions_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "leads"
            referencedColumns: ["id"]
      ...
      lead_profile: {
        Row: {
          ...
          lead_id: string
          medical_risk_details: string | null
          medical_risk_detected: boolean | null
          name: string | null
          notes: string | null
          phone: string | null
          photo_template_sent: boolean | null
      ...
      leads: {
        ...
        Relationships: [
          {
            foreignKeyName: "leads_doctor_approved_by_fkey"
          ...
          {
            foreignKeyName: "leads_sales_price_set_by_fkey"
            columns: ["sales_price_set_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          },
      ...
      photo_checklists: {
        Row: {
          ...
          min_required_count: number | null
    ...
    Functions: {
      check_photo_completion: {
        Args: { p_lead_id: string; p_treatment_category: string }
        Returns: {
